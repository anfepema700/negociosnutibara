...
<center>  
    ...
    <div class="container-fluid">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="cities">Listado</a></li>
                <li><a class="dropdown-item" href="cities">Editar</a></li>
                <li><a class="dropdown-item" href="cities/create">Guardar</a></li>
            </ul>
            </li>
